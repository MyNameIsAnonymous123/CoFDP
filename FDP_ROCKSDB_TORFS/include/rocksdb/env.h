...
class EnvWrapper : public Env {
 public:
  ...
  void SetTorFSOption(std::vector<uint64_t> torfsoption) override{
    target_.env->SetTorFSOption(torfsoption);
  }
