 ...
 */
#define MAX_ACTIVE_LOGS	128
#define MAX_ACTIVE_NODE_LOGS	64
#define MAX_ACTIVE_DATA_LOGS	64
...
// extern int write_fdp_inode(struct f2fs_node*, u64, unsigned int);
...
// extern int dev_write_fdp_block(void*,__u64,unsigned int);
