				...
				bool force_migrate)
{
	...
	for (segno = start_segno; segno < end_segno; segno++) {
		...
		// 	// Inconsistent segment (71) type [0, 1] in SSA and SIT
		// 	// [14729.902888] F2FS-fs (nvme0n1): Inconsistent segment (80) type [0, 1] in SSA and SIT
				...
				unsigned int secs, bool gc_only)
{
	...
	for(type = CURSEG_HOT_DATA; type < NR_CURSEG_PERSIST_TYPE; type++){
		for(hashindex=0;hashindex<sbi->segs_per_type;hashindex){
			f2fs_allocate_segment_for_resize(sbi, type, hashindex,start, end);
